    ...
    <section className="page">
      ...
      <motion.div className="container" variants={containerVariants} initial="hidden" animate="show">
        ...
        <motion.p variants={itemVariants}>
          Mindwell is a trauma-informed space that meets you with calm, tenderness, and clarity. We believe healing is
          slow, embodied, and beautifully non-linear.
        </motion.p>
        <motion.div className="editorial-grid" variants={itemVariants}>
          <div>
            <h2>Mission</h2>
            <p>
              We offer rituals for regulation, reflection, and gentle accountability. Every feature is built to feel
              like a soft room with warm light.
            </p>
          </div>
        ...
        <motion.div className="about-block block-sage" variants={itemVariants}>
          ...
          <p>Your notes, moods, and reflections are yours. We hold data with deep respect and never sell your story.</p>
        </motion.div>
        <motion.div className="editorial-grid" variants={itemVariants}>
          ...
          <div>
            ...
            <p>
              Mindwell blends somatic practice, mindful breathing, and gentle reflection. The goal is not perfection, it
              is presence.
            </p>
          </div>
        </motion.div>
        <motion.div className="about-block block-rose" variants={itemVariants}>
          ...
          <p>Spacious layouts, soft edges, and warm typography keep everything accessible and grounded.</p>
        </motion.div>
      </motion.div>
    </section>
  )
